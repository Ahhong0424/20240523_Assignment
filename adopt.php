...
<body>
    ...
    <div class="container-fluid">
        ...
        <br>
        <div class="container-fluid" style="background-color: #1985B6;color: white;">
        ...
        <div class="row row-cols-1 row-cols-md-2 g-4" style="text-align: center;">
            <div class="col">
                <div class="card" style="background-color: #1985B6; color: white;">
                    <img src="Image/AdoptCat1.png" class="card-img-top" alt="...">
                    <div class="card-body text-center">
                        <h5 class="card-title">Name - BOBI</h5>
                        <h5 class="card-text">Variety - Corgi</h5>
                        <h5 class="">Age - 2 Years old</h5>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card" style="background-color: #1985B6; color: white;">
                    <img src="Image/AdoptCat2.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Name - BOBI</h5>
                        <h5 class="card-text">Variety - Corgi</h5>
                        <h5 class="">Age - 2 Years old</h5>
            ...
            <div class="col">
                <div class="card" style="background-color: #1985B6; color: white;">
                    <img src="Image/AdoptCat3.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Name - BOBI</h5>
                        <h5 class="card-text">Variety - Corgi</h5>
                        <h5 class="">Age - 2 Years old</h5>
            ...
            <div class="col">
                <div class="card" style="background-color: #1985B6; color: white;">
                    <img src="Image/AdoptCat4.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Name - BOBI</h5>
                        <h5 class="card-text">Variety - Corgi</h5>
                        <h5 class="">Age - 2 Years old</h5>
            ...
            <div class="col">
                <div class="card" style="background-color: #1985B6; color: white;">
                    <img src="Image/AdoptCat5.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Name - BOBI</h5>
                        <h5 class="card-text">Variety - Corgi</h5>
                        <h5 class="">Age - 2 Years old</h5>
            ...
            <div class="col">
                <div class="card" style="background-color: #1985B6; color: white;">
                    <img src="Image/AdoptCat6.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Name - BOBI</h5>
                        <h5 class="card-text">Variety - Corgi</h5>
                        <h5 class="">Age - 2 Years old</h5>
